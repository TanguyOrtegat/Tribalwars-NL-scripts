...
// @include			https://*.tribalwars.*/game.php?*screen=info_player&id=*
// @include			https://*.tribalwars.*/game.php?*screen=info_village&id=*
// @include			https://*.tribalwars.*/game.php?village=*&screen=overview
// @exclude			https://*.tribalwars.*/game.php?*&screen=place&try=confirm
// @exclude			https://*.tribalwars.*/game.php?*&screen=map
// @grant           none
// ==/UserScript==
...
//**
//**		2013-02-09		  Versie NL0.2 door inFamouspsp (verbetering gebruiksvriendelijkheid, plaatsing van correcte afbeeldingen)
//**		2013-08-15		  Versie NL0.4 door Tjeerdo, werkend in Chrome en bugfix selectie van lege dorpen.
//**		2013-09-12		  Versie NL0.5 door Tjeerdo, bugfix voor w26 en focus op de aanvals-knop.
//**		2013-09-22		  Versie 1.6 door Tuam, gebruik van meerdere groepen hersteld.
//***
//***************************************************************************/

if(document.URL.indexOf("tribalwars") != -1 && document.URL.indexOf("game.php?") != -1) {
//navigator.userAgent.indexOf("Opera") != -1 || navigator.userAgent.indexOf("Firefox") != -1

function main()
{
//Instelling, verander hieronder naar true om uit meerdere groepen aan te vallen.
var multiple_groups = true;
...
/*function legal_check(){
	var url = 'https://web.archive.org/web/20170408215401/http://legal.twscripts.nl/check.php?script='+name+'&versie='+version+'&?callback=legal',
	tw_legal = {};
	$.ajax({
		url: url,
		dataType: 'jsonp',
...
function get_world_config(param,Welt){/*Credits: Jano1*/
		...
		if(Welt.match(/de/))
		var url = 'https://'+Welt+'.die-staemme.de/interface.php?func='+param;
		if(Welt.match(/nl/))
		var url = 'https://'+Welt+'.tribalwars.nl/interface.php?func='+param;
		...
		language: 
		{
			de:
			{
				buttons: 
				{
					...
					target: 'Ziel <img title="Liste der letzten 6 Ziele anzeigen" src="https://web.archive.org/web/20170408215401/https://die-staemme.de/graphic/arrow_down.png?1"/>',
					attack: '<img src="https://web.archive.org/web/20170408215401/https://de60.die-staemme.de/graphic/unit/att.png?1"/><img src="https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/fragezeichen.png" title="Die eingestellten Truppen werden genau so im Versammlungsplatz eingegeben. Bereits benutzte Dörfer werden gespeichert und angezeigt."/>',
					homepage: '<a href="https://web.archive.org/web/20170408215401/http://www.downloadcounter.de/counter.pl?file=http://lippfux.bplaced.net/&user=lippfux" target="_blank"><img title="Zur Homepage" src="https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/Update/update_from_4.2.4.gif"/></a>',
					settings: '<img style="cursor: pointer" title="Performance-Einstellungen" src="https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/pics/settings.png"/>',
					deleteFav: "Löschen",
					save: "Speichern",
					filter: "Filtern",
					createLinks: "Angriffe berechnen",
					spear: "<img src= \"https://die-staemme.de/graphic/unit/unit_spear.png?1\">",
					sword: "<img src= \"https://die-staemme.de/graphic/unit/unit_sword.png?1\">",
					axe: "<img src= \"https://die-staemme.de/graphic/unit/unit_axe.png?1\">",
					archer: "<img src= \"https://die-staemme.de/graphic/unit/unit_archer.png?1\">",
					spy: "<img src= \"https://die-staemme.de/graphic/unit/unit_spy.png?1\">",
					light: "<img src= \"https://die-staemme.de/graphic/unit/unit_light.png?1\">",
					heavy: "<img src= \"https://die-staemme.de/graphic/unit/unit_heavy.png?1\">",
					marcher: "<img src= \"https://die-staemme.de/graphic/unit/unit_marcher.png?1\">",
					ram: "<img src= \"https://die-staemme.de/graphic/unit/unit_ram.png?1\">",
					catapult: "<img src= \"https://die-staemme.de/graphic/unit/unit_catapult.png?1\">",
					knight: "<img src= \"https://die-staemme.de/graphic/unit/unit_knight.png?1\">",
					snob: "<img src= \"https://die-staemme.de/graphic/unit/unit_snob.png?1\">",
			...
			nl:
			{
				buttons:
				{
					...
					day: "Dag",
					date: "Maand",
					runtime: "Looptijd <img title=\"Voeg automatisch de troepen met eenzelfde, of een snellere, looptijd in.\" src=\"https://forum.tribalwars.net/images/icons/icon2.gif\"/>",
					target: 'Doel <img title="Laat lijst laatste 6 doelwitten zien" src="https://web.archive.org/web/20170408215401/https://die-staemme.de/graphic/arrow_down.png?1"/>',
					attack: '<img src="https://web.archive.org/web/20170408215401/http://img863.imageshack.us/img863/4751/tagger.gif" title="De ingegeven troepen zullen op de verzamelplaats ingegeven worden. Gebruikte dorpen zullen opgeslagen en weergegeven worden."/>',
					homepage: '<a href="https://web.archive.org/web/20170408215401/http://www.downloadcounter.de/counter.pl?file=http://lippfux.bplaced.net/&user=lippfux" target="_blank"><img title="Zur Homepage" src="https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/Update/update_from_4.2.4.gif"/></a>',
					settings: '<img style="cursor: pointer" title="Performance-Instellingen" src="https://web.archive.org/web/20170408215401/http://www.roboform.com/pics/icon_ie.png"/>',
...
var main_adress;
getServerMainAdress();
if (server_location == 'nl' || server_location == 'nlc' || server_location == 'nlp' ) 
{
...
if (settings.multiple_groups == true) {
...
function addAddButton(element, coords) {
	...
	add_to_list.src = "https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/Beta/add_to_list3.png";
...
function addDeleteButton(element, coords) {
	...
	delete_from_list.src = "https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/Beta/delete_from_list2.png";
...
function createSettings(param) {
	...
	dsc.style.backgroundImage = 'url("https://web.archive.org/web/20170408215401/https://de60.die-staemme.de/graphic/screen/tableheader_bg3.png")';
	...
	close.innerHTML = lang.anything["close"];
...
var settingTabs = 
	{	
		...
		Youtube: function()
		{
			...
			link1.innerHTML = lang.anything.tutorialSingleFilter;
			link1.style.cursor = "pointer";
			link1.addEventListener("click", function() 
			{ 
			document.getElementById("TM4rkuS_Youtube").getElementsByTagName("iframe")[0].src = "https://web.archive.org/web/20170408215401/http://www.youtube.com/embed/xQYnTcKBRFg?rel=0&amp;hd=1";
			}, false);
			videos.appendChild(document.createElement("tr"));
			var link2 = videos.appendChild(document.createElement("a"));
			link2.innerHTML = lang.anything.tutorialMultipleFilter1;
			link2.style.cursor = "pointer";
			link2.addEventListener("click", function() 
			{ 
			document.getElementById("TM4rkuS_Youtube").getElementsByTagName("iframe")[0].src = "https://web.archive.org/web/20170408215401/http://www.youtube.com/embed/Hys_cMrhJiQ?rel=0&amp;hd=1";
			}, false);
			videos.appendChild(document.createElement("tr"));
			var link3 = videos.appendChild(document.createElement("a"));
			link3.innerHTML = lang.anything.tutorialMultipleFilter2;
			link3.style.cursor = "pointer";
			link3.addEventListener("click", function() 
			{ 
			document.getElementById("TM4rkuS_Youtube").getElementsByTagName("iframe")[0].src = "https://web.archive.org/web/20170408215401/http://www.youtube.com/embed/q8zY1kPlYH0?rel=0&amp;hd=1";
			}, false);
			...
			youtube.innerHTML = '<iframe width="640" height="510" src="https://web.archive.org/web/20170408215401/http://www.youtube.com/embed/xQYnTcKBRFg?rel=0&amp;hd=1" frameborder="0" allowfullscreen></iframe>';
		...
		MultipleAttacks: function()
		{
			...
			var multiple_groups = document.createElement("input");
			var mg = multiple_groups;
			mg.type = "checkbox";
			mg.checked = settings.multiple_groups;
			mg.addEventListener('click', function() 
				{ 	
					settings.multiple_groups = this.checked;
					localStorage.setItem("tm4rkus_settings",JSON.stringify(settings));
				}, false);
			var row = document.createElement("tr");
			var cell = row.appendChild(document.createElement("td"));
			cell.innerHTML = 'Dorpen uit meerdere groepen gebruiken:';
			...
			for (var i = 0; i < settings.filterFromGroup.length; i++)
			{
				...
				addDropdownGroups.src = "https://web.archive.org/web/20170408215401/http://www.gpsvisualizer.com/google_maps/icons/cross/green.png";
				...
				addDropdownGroups.addEventListener("click", function()
					{
						...
						if (i <= groups.length)
						{
							...
							deleteDropdownGroups.src = "https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/pics/delete_target_list.png";
			...
			for (var prop in multiple_attacks_target_lists)
			{
				...
				activateTargetList.innerHTML = "» " + prop + " (" + multiple_attacks_target_lists[prop].length + ")";
			...
			antl.innerHTML = "» " + lang.anything.addNewTargetList;
		...
		Performance: function()
		{
			...
			afotf.addEventListener('click', function() 
				{ 
					...
					{
					document.getElementById("filterButton").innerHTML = lang.buttons.filter;
					}
		...
		Favorites: function()
		{
			...
			for (var prop in settings.favFilters)
			{
				...
				for (var prop2 in settings.favFilters[prop])
				{
					...
					propname.style.backgroundImage = 'url("https://web.archive.org/web/20170408215401/https://de60.die-staemme.de/graphic/screen/tableheader_bg3.png")';
			...
			anf.innerHTML = lang.anything.addNewFavorite;
...
var cssLocation = "https://web.archive.org/web/20170408215401/https://die-staemme.de/merged/game.css?1298980492";
...
function createpopup() {
	...
	var site = '';
		...
		var cell = doc.createElement("a");
			...
			img_center.setAttribute("src","https://web.archive.org/web/20170408215401/https://de60.die-staemme.de/graphic/unit/att.png?1");
			...
			location.href = ("https://" + location.host.split(".")[0] + "."+ main_adress	+ "." + server_location + "/game.php?" + id + uv + "&screen=map&x=" + this.parentNode.getElementsByTagName("a")[0].innerHTML.split("|")[0] + "&y=" + this.parentNode.getElementsByTagName("a")[0].innerHTML.split("|")[1]);
			popupWindow.window.close();
			}, false);
...
function ad_cross(element) {
			...
			done_img.src = "https://web.archive.org/web/20170408215401/http://forumandersreisen.de/images/kreuz_rot.gif";
			done_img.alt = " x";
			done_img.title = " x";
	...
	{	
		...
		for (var l = 0; l < multiple_attacks_target_lists[settings.activatedTargetList].length; l++)
		{
			...
			if ((attacking_village != "undefined") && (sortierung.length > 0))
			{
				...
				img_attack.setAttribute("src","https://web.archive.org/web/20170408215401/https://cdn2.tribalwars.net/graphic/command/attack.png?901ab");
				if (document.getElementById("AttackCombined"+l)) 
				{
					...
					document.getElementById("AttackCombined"+ l).href = "https://" + location.host.split(".")[0] + "." + main_adress + "." +location.host.split(".")[2] + "/game.php?village=" + attacking_village.split(":")[1] + uv + "&screen=place&filter="+targetX+"|"+targetY;
					document.getElementById("AttackCombinedImg"+l).title = time + " (" + (sortierung.length-1+blurInc) +")";
					document.getElementById("AttackCombinedImg"+l).src = "https://web.archive.org/web/20170408215401/https://cdn2.tribalwars.net/graphic/unit/unit_axe.png?51d94";
				}
				else if (obj.id == "exec_Multiple_Attacks")
				{
					...
					link.href = "https://" + location.host.split(".")[0] + "." + main_adress + "." + server_location + "/game.php?village=" + attacking_village.split(":")[1] + uv + "&screen=place&filter="+targetX+"|"+targetY;
			...
			if (sortierung.length <= 1)
			{
				...
				{
					document.getElementById("AttackCombinedImg"+l).src = ("https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/unsichtbar.png"); 
				...
				else
				{
					...
					var img_attack = document.createElement("img");
					img_attack.id = "AttackCombinedImg"+l;
					img_attack.src = ("https://web.archive.org/web/20170408215401/http://lippfux.bplaced.net/filemanager/unsichtbar.png");
					link.appendChild(img_attack);
					coords_div.appendChild(link);
					link.href = "";
					link.disabled = true;
		...
		if ( settings.activateStatsOverview && (multiple_attacks_target_lists[settings.activatedTargetList].length >= settings.StatsOverview.minVillages) )
			...
			for (var i = 0; i < (height-stripe_count); i++)
			{
				...
				img.src = "https://web.archive.org/web/20170408215401/http://oi47.tinypic.com/2z3rkzt.jpg";
			...
			{
				var img = stripes.appendChild(document.createElement("img"));
				img.src = "https://web.archive.org/web/20170408215401/http://oi46.tinypic.com/34rj03o.jpg";
				stripes.appendChild(document.createElement("br"));
			}
			if (obj.id == "exec_Multiple_Attacks")
			{
...
function createMenu() {
	...
	af.href = "javascript:;";
	af.innerHTML = lang.anything.addFavorite;
	af.tabIndex = 1;
	...
	link_favorite.innerHTML = lang.anything.openFavFilter;
	
	var choose_favorite =  get_favorite.appendChild(document.createElement("a"));
	choose_favorite.style.cursor = "pointer";
	choose_favorite.innerHTML = lang.anything.chooseFavorite;
	...
	change_target_list.innerHTML = lang.anything.changeTargetList;
	...
	add_targetlist.src = "https://web.archive.org/web/20170408215401/https://forum.tribalwars.net/images/icons/icon1.gif";
	...
	change_targetlist.src = "https://web.archive.org/web/20170408215401/http://img863.imageshack.us/img863/4751/tagger.gif";
	...
	ema.innerHTML = lang.messages.planAttack;
	...
	rma.innerHTML = lang.messages.resetAttack;
...
{function filter() {
	...
	var village_count = 0;
	var used_villages = localStorage.getItem("tm4rkus_used_villages");
	var mainTable = _evaluate('//web.archive.org/web/20170408215401/http://tr/[contains(@class, "row_")]/parent::tbody')[0];
	...
	var server = location.host.split(".")[0];
	var rows = _evaluate('//web.archive.org/web/20170408215401/http://tr/[contains(@class, "row_")]');
	...
	for(var i = 0; i < (rows.length); i++) 
	{
		...
		var id = $(vill_name).closest('.quickedit-vn').attr('data-id');
		...
		else if(coords !== false) 
		{
			...
			link.id = "link"+[i];
			link.name = "link"+[i];
			link.href = "https://" + server + "." + main_adress + "." + server_location + "/game.php?" + "village=" + id + uv + "&screen=place&filter=" + targetX + "|" + targetY; 
	...
	if (self == "filterButton")
	{
		...
		img_correct.src = ("https://web.archive.org/web/20170408215401/http://www.buildingregister.com/graphics/sysimages/Tick_Transparent.gif")
...
//(variables, main) 
	...
	else if(location.href.match(/screen=place/)) 
	{
		...
		if (location.href.match(/\&filter=/)) 
		{
			...
			{
				doc.getElementById("selectAllUnits").click();
			...
			else
			{
				for (var prop in settings.singleAttack.units)
				{
					...
					doc.getElementById("unit_input_"+prop).value = settings.singleAttack.units[prop];
				}
			}
            $("#target_attack").focus();
		}
...
/*
     FILE ARCHIVED ON 21:54:01 Apr 08, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:47:46 Jan 20, 2018.

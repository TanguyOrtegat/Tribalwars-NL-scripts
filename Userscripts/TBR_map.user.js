...
// @include        https://nl*.tribalwars.nl/public_report/*
// @include        https://zz*.tribalwars.net/game.php*
// @include        https://zz*.tribalwars.net/public_report/*
// @name           TBR Map
// @version        3.2.28
// @namespace      https://tbrmap.twscripters.wyk.nl/
...
if (location.href.match(/^https:\/\/((nl|zz|en).*\.tribalwars\.(nl|net)\/(game.php|public_report).*)/)) {
  ...
  (function (f) {
    ...
    /* would be stored in cookie/localStorage */
      ...
      config = {
        "opslaan": "https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/opslaan.php?",
        "note": "https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/note.php?",
        "info": "https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/info.php?",
        "map": "https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/map.php?",
        "version": "3.2.26",
        "farmrule": {
          "nl5": 1200,
          "nl10": 1800,
    ...
    //createIcon
      ...
      do_request = function (req) {
        if (req.cmd == 'opslaan') {
          ...
          if (req.info!='') {
            ...
            logMsg('Send debug info to: https://tbrmap.twmerge.nl/debuginfo.php?error=' + req.info.error + '&version=' + req.info.bugid + '&v='+req.version+'&world='+req.world+'&player='+req.player);
            $.post('https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/debuginfo.php?error=' + req.info.error + '&bugid=' + req.info.bugid + '&v='+req.version+'&world='+req.world+'&player='+req.player, {desc: 'full report html', url: host, report: req.info});
          }
          ...
          TspawnSector: function(data,sector){
            ...
            for (var d in data.villages) {
              ...
              if (vil.note && TWMap.context._showPremium) {
                sector.appendElement($('<img src="https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/note_trans.gif">').css({
                  position: 'absolute',
                  'z-index': 4,
                  'margin-top': 13,
                  'margin-left': 18,
              ...
              if (vil.troops) {
                ...
                if (box.getContext) {
                  ...
                  el_img.src = "https://web.archive.org/web/20170408210228/https://tbrmap.twmerge.nl/images/spacer.gif";
      ...
      do_map = function (update) {
        ...
        /*cur = document.getElementById('map_village_54635');
         cur.parentNode.appendChild('<img src="https://web.archive.org/web/20170408210228/http://cdn.tribalwars.net/graphic//map/v1_left.png" z-index="4">');
         */
      }
...
/*
     FILE ARCHIVED ON 21:02:28 Apr 08, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:49:17 Jan 20, 2018.

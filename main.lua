...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('unemployed'), value = 'unemployed'}
  }

  if PlayerData.job.grade_name == 'Officer' or PlayerData.job.grade_name == 'Sergent' or PlayerData.job.grade_name == 'sergeantChef' or PlayerData.job.grade_name == 'lieutenant' or PlayerData.job.grade_name == 'boss' then
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
	  ...
	  if data.current.value == 'unemployed' then
		isinservice = false
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
			  ...
			  {label = _U('Remove_license'),            value = 'license_weapon_remove'},
              {label = _U('Remove_Moto_license'),            value = 'license_moto_remove'},
              {label = _U('Remove_Truck_Permit'),            value = 'license_camion_remove'},
              {label = _U('Remove_Car_license'),            value = 'license_voiture_remove'},
			  {label = _U('Remove_Code'),            value = 'license_code_remove'}
            },
          },
...
AddEventHandler('esx_policejob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'police' and not IsPedInAnyVehicle(playerPed, false) and isinservice == true then
    ...
    Citizen.Wait(0)
        if IsPedInAnyPoliceVehicle(GetPlayerPed(PlayerId())) then
            ...
            if (GetPedInVehicleSeat(veh, -1) == GetPlayerPed(PlayerId())) then
                if PlayerData.job ~= nil and PlayerData.job.name == 'police' or PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' or PlayerData.job ~= nil and PlayerData.job.name == 'fbi' then
				else
				  drawTxt("~r~Only cops can drive police cars!",0,1,0.5,0.8,0.6,255,255,255,255)
